...
export default function App() {
    ...
    const onPressFunction = () => {
        alert('¡Presionaste el Pressable!');
        console.log('Función onPressFunction ejecutada.');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableHighlight
                underlayColor={"#09f"}
                onPress={() => alert('Hola desde Highlight')} // Aquí usaste una función anónima, por eso funcionó.
            ...
            {/* Ahora Pressable funciona porque 'onPressFunction' ya existe. */}
            <Pressable onPress={onPressFunction}>
                <Text style={{color: 'purple', marginTop: 20}}>Presioname</Text>
            </Pressable>
        </View>
    );
}
